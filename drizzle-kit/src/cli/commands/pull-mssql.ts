...
export const handle = async (
	...
	// Separate warnings (index_duplicate) from fatal errors
	const warnings = errors.filter((e) => e.type === 'index_duplicate');
	const fatalErrors = errors.filter((e) => e.type !== 'index_duplicate');
